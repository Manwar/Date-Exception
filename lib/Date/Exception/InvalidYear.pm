package Date::Exception::InvalidYear;

$Date::Exception::InvalidYear::VERSION   = '0.03';
$Date::Exception::InvalidYear::AUTHORITY = 'cpan:MANWAR';
...
Handles 'invalid year' exception, with statu code C<103>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Date::Exception::InvalidYear
...
1; # End of Date::Exception::InvalidYear
